...
def root():
    return 'Seja Bem Vindo(a)<br><br> API CALCULATOR <br><br> Digite qual operação gostaria de fazer entre as opções <br> <br>' + \
           ...
           '9 -  ' 'https://dsdtrabalho-andredelcole.herokuapp.com/mod/firtsvalue;second;third;... <br> <br> <br>' 'Obrigado por Utilizar a API Calculator'
           '<br><br><br><br><br><br><br><br>' 'Trabalho Desenvolvido na Disciplina de Desenvolvimento de Sistemas Distribuidos'
